...
export const projectsList: IProject[] = [
  ...
  {
    name: 'FizjoLifting',
    note: 'Strona zaprojektowana oraz wykonana przeze mnie na potrzeby gabinetu rehabilitacyjnego. Schludny i przejrzysty interfejs stworzony został przy użyciu React + JavaScript oraz styled-components.',
  ...
  {
    name: 'Portfolio',
    note: 'Strona, na której się znajdujesz jest moim pierwszym opublikowanym projektem napisanym w React + TypeScript. Duży nacisk połozyłem na skalowalność projektu, dzięki czemu wprowadzanie zmian odbywa się w zasadzie w jednym pliku konfiguracyjnym.',
